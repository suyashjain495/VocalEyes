package com.example.vocaleyesnew.facenet_android.presentation.components
...
import com.example.vocaleyesnew.facenet_android.presentation.screens.detect_screen.DetectScreenViewModel
        ...
        ImageAnalysis.Analyzer { image ->
            ...
            CoroutineScope(Dispatchers.Default).launch {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    // Announce detected faces using Indian accent TTS
                    viewModel.announceDetectedFaces(results)
